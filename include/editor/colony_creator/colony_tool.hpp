...
struct ColonyTool : GUI::Container
{
        ...
        , control_state(control_state_)
    {
        ...
        auto remove_button = create<GUI::Button>("", [](){}); // REMOVE_REMOVE
        remove_button->setHeight(0.0f);
        remove_button->setWidth(0.0f);
